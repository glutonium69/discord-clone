function CommonIcons() {
    ...
    const SearchIcon = (
        <svg
            className="icon_f50f05 visible__4d9aa"
            aria-hidden="true"
            role="img"
            width="24"
            height="24"
    ...
    return [Help, Inbox, PinnedMsg, SearchIcon];
}
...
function IconsInDM() {
    ...
    return [AddFriend, UserPfp, VideoCall, VoiceCall];
}

function IconsInServer() {
	const MemberList = (
		<svg
			x="0"
			y="0"
	...
	return [MemberList, Notification, Threads];
}

export { CommonIcons, IconsInDM, IconsInServer };